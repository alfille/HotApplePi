...
class Pinhole {
	constructor(canvas_id) {
		...
		const canvas = new WorkerCanvas(canvas_id);
	...
	buttons(div_id) {
		const d = getElementById( div_id ) ;
		[
			this.button( "<B>&#8592;</B>", this.Yp ),
			this.button( "<B>&#8595;</B>", this.Xm ),
			this.button( "&#8630;", this.Zp ),
			this.button( "<B>X</B>", this.stop ),
			this.button( "&#8631;", this.Zm ),
			this.button( "<B>&#8593;</B>", this.Xp ),
			this.button( "<B>&#8594;</B>", this.Ym ),
