...
Although in theory \\(L\\) is the sole parameter in the equation, finding \\(a\_0\\) is a challenge. We can simplify it by using our constraints to reduct the search range. Let
\\[a\_0=\alpha L\\] 

Then \\[f(s)=\alpha L + a\_2 s\^2 + a\_4 s\^4 + \cdots\\]
\\[f'(s)=2 a\_2 s + 3 a\_4 s\^3 + \cdots\\]
...
Using the solution technique for the coefficients \\(a\_i\\) used above 'poly6.mac'

\\[f(s)=\alpha L + \sum\_{i=2,4,\cdots}\frac{(-1)\^{i/2}(1-2 \alpha)\\,s\^i}{i!\\,\lbrace\alpha(1-\alpha)L\rbrace\^{i-1}}P\_i\\]
\\[P\_2=1 \\]
\\[P\_4=6 \alpha\^2-6 \alpha+1 \\]
\\[P\_6=108 \alpha\^4-216 \alpha\^3+138 \alpha\^2-30 \alpha+1 \\]
\\[P\_8=3528 \alpha\^6-10584 \alpha\^5+11952 \alpha\^4-6264 \alpha\^3+1494 \alpha\^2-126 \alpha+1 \\]
\\[P\_{10}=184464 \alpha\^8-737856 \alpha\^7+1199664 \alpha\^6-1016496 \alpha\^5+476820 \alpha\^4-120312 \alpha\^3+14226 \alpha\^2-510 \alpha+1 \\]
